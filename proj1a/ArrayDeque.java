public class ArrayDeque<T> {
    ...
    private T[] resize(T[] array) {
        ...
        System.arraycopy(array, getPrevIndex(nextFirst), a, 0, array.length-getPrevIndex(nextFirst));
        System.arraycopy(array, 0, a, array.length-getPrevIndex(nextFirst), getNextIndex(nextLast));
    ...
    public T get(int index) {
        ...
        int first = getPrevIndex(nextFirst);
